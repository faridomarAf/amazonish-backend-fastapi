...
def upgrade() -> None:
    ...
    op.create_table('customers',
                    ...
                    sa.Column('created_at', mysql.DATETIME(fsp=6), server_default=sa.text(
                        'CURRENT_TIMESTAMP(6)'), nullable=False),
                    sa.Column('updated_at', mysql.DATETIME(fsp=6), server_default=sa.text(
                        'CURRENT_TIMESTAMP(6)'), nullable=False),
                    sa.PrimaryKeyConstraint('id')
                    )
    op.create_index(op.f('ix_customers_email'),
                    'customers', ['email'], unique=True)
    op.create_index(op.f('ix_customers_phone'),
    ...
    op.create_table('event_inbox',
                    ...
                    sa.Column('received_at', mysql.DATETIME(fsp=6), server_default=sa.text(
                        'CURRENT_TIMESTAMP(6)'), nullable=False),
                    sa.PrimaryKeyConstraint('id')
                    )
    op.create_table('outbox_events',
                    ...
                    sa.Column('created_at', mysql.DATETIME(fsp=6), server_default=sa.text(
                        'CURRENT_TIMESTAMP(6)'), nullable=False),
                    sa.Column('published_at', mysql.DATETIME(
                        fsp=6), nullable=True),
                    sa.Column('publish_attempts',
    ...
    op.create_index(op.f('ix_outbox_events_event_id'),
                    'outbox_events', ['event_id'], unique=True)
    ...
    op.create_index(op.f('ix_products_status'),
                    'products', ['status'], unique=False)
    ...
    op.create_index(op.f('ix_customer_addresses_customer_id'),
                    'customer_addresses', ['customer_id'], unique=False)
    op.create_table('skus',
                    ...
                    sa.Column('price_amount', sa.DECIMAL(
    ...
    op.create_index(op.f('ix_skus_product_id'), 'skus',
    ...
    op.create_table('orders',
                    ...
                    sa.Column('customer_id', sa.BigInteger(), nullable=False),
                    sa.Column('status', sa.String(length=32), nullable=False),
                    sa.Column('total_amount', sa.DECIMAL(
                        precision=19, scale=4), nullable=False),
                    ...
                    sa.Column('updated_at', mysql.DATETIME(fsp=6), server_default=sa.text(
                        'CURRENT_TIMESTAMP(6)'), nullable=False),
                    sa.ForeignKeyConstraint(['billing_address_id'], [
                        'customer_addresses.id'], ondelete='SET NULL'),
                    sa.ForeignKeyConstraint(
                        ['customer_id'], ['customers.id'], ondelete='RESTRICT'),
                    sa.ForeignKeyConstraint(['shipping_address_id'], [
                        'customer_addresses.id'], ondelete='SET NULL'),
                    sa.PrimaryKeyConstraint('id')
                    )
    ...
    op.create_table('order_items',
                    ...
                    sa.Column('unit_amount', sa.DECIMAL(
                        precision=19, scale=4), nullable=False),
                    sa.Column('unit_currency', sa.String(
                        length=3), nullable=False),
                    sa.Column('created_at', mysql.DATETIME(fsp=6), server_default=sa.text(
                        'CURRENT_TIMESTAMP(6)'), nullable=False),
                    sa.ForeignKeyConstraint(
    ...
    op.create_index(op.f('ix_order_items_sku_id'),
                    'order_items', ['sku_id'], unique=False)
